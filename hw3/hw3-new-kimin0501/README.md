...
1) Visual Hierarchy: I emphasized the "Today's featured item" by using bold text for the item's name and price. This leads users to be more interested in the information of "Today's featured item" than other content.

2) Contrast: I used different background colors for normal items and "Today's featured item". This makes a visual difference, making it easier for users to distinguish between "Today's featured item" and normal items.

3) Consistency: I applied the same style to evert button. This helps users understand how to interact with the button by giving them predictable appearance and behavior.
...
![Step 7 Sketch](_figures/step7.png)
